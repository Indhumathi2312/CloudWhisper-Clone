            ...
            <div data-w-id="f1ff1ac2-5ccd-56f8-612a-0570791caa19" className="footer-main-section">
              ...
              >
                <div className="footer-top">
                  <div className="footer-v1-top-left">
                    <div>
                      <a
                        ...
                        ><img
                          ...
                          width="194"
                          height="29"
                          alt="Header Logo - CloudWhisper - Webflow Template | BRIX Templates"
                          className="width-100"
                      /></a>
                      <p className="text-neutral-light mg-top-3x-extra-small">
                        Lorem ipsum dolor sit amet consectetur. Sed eleifend
                        ultrices sed eget.
                      </p>
                    </div>
                    <img
                      ...
                      width="83"
                      height="83"
                      alt="QR Code - CloudWhisper - Webflow Template | BRIX Templates"
                      className="qr-code"
                    />
                  </div>
                  <div className="grid-2-columns footer-pages-grid">
                    <div id="w-node-f1ff1ac2-5ccd-56f8-612a-0570791caa49-791caa18">
                      <h3 className="footer-pages-title">Main pages</h3>
                      <div className="w-layout-grid footer-pages-grid">
                        <div className="w-layout-grid footer-pages-column">
                          <a href="/" className="footer-link">Preview</a
                          ><a href="/home-pages/home-v1" className="footer-link"
                            >Home V1</a
                          ><a
                            ...
                            >Home V2</a
                          ><a href="/home-pages/home-v3" className="footer-link"
                            >Home V3</a
                          ><a href="/company-pages/about" className="footer-link"
                            >About us</a
                          ><a href="/blog-pages/blog-v1" className="footer-link"
                            >Blog V1</a
                          >
                        </div>
                        <div className="w-layout-grid footer-pages-column">
                          <a href="/blog-pages/blog-v2" className="footer-link"
                            >Blog V2</a
                          ><a href="/blog-pages/blog-v3" className="footer-link"
                            >Blog V3</a
                          ><a
                            href="/blog-posts/breaking-language-barriers-with-multilingual-speech-ai"
                            className="footer-link"
                            >Blog post</a
                          ><a href="/contact-pages/contact-v1" className="footer-link"
                            >Contact V1</a
                          ><a href="/contact-pages/contact-v2" className="footer-link"
                            >Contact V2</a
                          ><a href="/contact-pages/contact-v3" className="footer-link"
                            >Contact V3</a
                          >
                        </div>
                        <div className="w-layout-grid footer-pages-column">
                          <a href="/product-pages/features" className="footer-link"
                            >Features</a
                          ...
                          ><a
                            ...
                            className="footer-link"
                            >Career single</a
                          ><a href="/product-pages/integrations" className="footer-link"
                            >Integrations</a
                          ><a href="/integrations/netspire" className="footer-link"
                            >Integration single</a
                          ><a href="/user-pages/sign-in" className="footer-link"
                            >Sign in</a
                          >
                        </div>
                        <div className="w-layout-grid footer-pages-column">
                          <a href="/user-pages/sign-up" className="footer-link"
                            >Sign up</a
                          ><a
                            href="/landing-pages/request-a-demo"
                            className="footer-link"
                            >Request a demo</a
                          ><a href="/landing-pages/coming-soon" className="footer-link"
                            >Coming soon</a
                          ><a
                            ...
                            ><img
                              ...
                              width="28"
                              height="28"
                              alt="Webflow Icon - CloudWhisper - Webflow Template | BRIX Templates"
                              className="footer-link-icon"
                            />
                            <div>More Webflow Templates</div></a
                          >
                        </div>
                      </div>
                    </div>
                    <div id="w-node-f1ff1ac2-5ccd-56f8-612a-0570791caa7f-791caa18">
                      <h3 className="footer-pages-title">Utility pages</h3>
                      <div className="w-layout-grid footer-pages-column">
                        <a href="/template-pages/start-here" className="footer-link"
                          >Start here</a
                        ><a href="/template-pages/styleguide" className="footer-link"
                          >Styleguide</a
              ...
              >
                <div className="footer-middle">
                  <div className="inner-container _480px center">
                    <div className="center-content">
                      <div className="subtitle pink">Download now</div>
                      <div className="display-8 text-titles mg-top-5x-extra-small">
                        Everything you need to amplify your voice
                      </div>
                      <div className="mg-top-2x-extra-small mg-bottom-24px">
                        <div className="flex-center vertical-mbp">
                          ...
                          <div className="text-titles">150K+ people already joined</div>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        <a
                          ...
                          className="primary-button dark-mode w-inline-block"
                          ><div>Start free trial</div></a
                        >
                ...
                <div className="footer-bottom v1">
                  ...
                  >
                    Copyright © CloudWhisper | Designed by
                    <a
                  ...
                  <div
                    id="w-node-c992285a-71a8-e243-29d9-6637d3b5bd20-791caa18"
                  ...
                  >
                    <a
                      ...
                      ><img
                        ...
                        width="20"
                        height="20"
                        alt="X Icon - CloudWhisper - Webflow Template | BRIX Templates" /></a
                    ><a
                      href="https://www.linkedin.com/"
                      target="_blank"
                      className="social-square-icon-link white w-inline-block"
                      ><div className="icon-font-social-media"></div></a
                    ><a
